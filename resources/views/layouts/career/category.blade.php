...
@section('main-content')
 ...
 <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
               <div class="div">
                <h4 class="float-right d-inline"><a href="#add_cat" class="btn btn-info" data-toggle="modal">Add Job Position</a></h4>
               </div>
               <br><br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('careerCategory.store') }}" method="POST"  class="form-group">
                        @csrf
                        <input class="form-control" type="text" name="cat_name" placeholder="position name"><br>
