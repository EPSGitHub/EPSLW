                        ...
                        <div class="card-body">
                            <form action=" {{ route('careers.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea rows="5" cols="5" name="description" value="{{ old('description') }}"  class="form-control" id="ckeditor"  placeholder="Enter text here"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                       <input type="checkbox" value="0" id="careerpostdraft" name="status" value="Bike">
