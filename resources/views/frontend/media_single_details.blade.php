...
<div class="container-fluid pagehead" id="pagehed">
    <h3>Media</h3>
    <p><a href="{{ url('/') }}">home</a> / <a href="{{ route('frontend.media') }}">Media</a> / gallery details</p>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 relatedoffer">
                    ...
                    <div class="offercard2">
                        <a href=""><img src="{{ URL::to('') }}/frontend/img/media/event1.png" alt=""></a>
                        <p href="">Special Offer</p>
                    </div>

                    <div class="offercard2">
                        <a href=""><img src="{{ URL::to('') }}/frontend/img/media/event2.png" alt=""></a>
                        <p href="">Special Offer</p>
                    </div>

                    <div class="offercard2">
                        <a href=""><img src="{{ URL::to('') }}/frontend/img/media/event3.png" alt=""></a>
                        <p href="">Special Offer</p>
                    </div>
