...
<!-- // Start Code From Here -->
	...
	<div class="container-fluid pagehead" id="pagehed">
		<h3>iOS App Download</h3>
        <p><a href="{{ url('/') }}">home<a> / <a href="{{ route('frontend.app_details')}}"> about Apps </a>/ ios app</p>
	</div>
	<!-- page header END -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="col-md-12 appright card">
                            ...
                            <a href="#" class="btn btn-success">Download iOS App</a>

                        </div>

                        <div class="col-md-12 apprightbottom card">

                            <p style="text-align: left"> Download EPS Android App for Android User  .</p>

                            <a href="{{ route('frontend.apk') }}" class="btn btn-success">Download Android App</a>
